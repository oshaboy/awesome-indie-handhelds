...
| ESPboy  | ESP8266 (160 MHz Xtensa)   | 80 KiB  |  128x128 RGB (ST7735) |1-bit Speaker| C/C++ (Little Game Engine, Arduino, Arduboy, Gamebuino META), Lua, BASIC, MicroPython, VPL (Scratch), Z80 Assembly (Gameboy, ZX Spectrum), SChip-8  | 4 MiB  |  App Store |75/95 USD  | Yes   | https://www.espboy.com/  |
...
| Gamebuino META | ATSAMD21 (48 MHz Cortex M0+) | 32 KiB | 160x128 RGB |10-bit DAC| CircuitPython, C/C++ (Arduino) | 256KiB | Micro SD | 70 EUR | No | https://gamebuino.com/ |
...
| Nibble  |  ESP8266 (160 MHz Xtensa) | 80 KiB  | 128x128   RGB  |1-bit Buzzer|  C/C++ (Arduino), CircuitPython, VPL (CircuitBlocks)  |  4MiB | N/A  |  75.99 USD |  Yes |  https://circuitmess.com/nibble/ |
